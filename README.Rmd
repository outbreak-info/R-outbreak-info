...
## Getting Started
If you're getting started using **outbreakinfo**, we recommend starting with our tutorial [vignettes](https://outbreak-info.github.io/R-outbreak-info/docs/articles/index.html).
...
Please view our [vignettes](https://outbreak-info.github.io/R-outbreak-info/docs/articles/index.html) for examples of how to use the R package.
...
``` {r variant_tracker, message = FALSE, warning = FALSE}
...
``` {r location_tracker, message = FALSE, warning = FALSE}
library(outbreakinfo)
#  Provide GISAID credentials using authenticateUser()
...
```{r resources_by_date, message = FALSE, warning = FALSE}
library(outbreakinfo)
library(dplyr)
library(ggplot2)
library(lubridate)
