...
usa_60d = getAllLineagesByLocation(location = country, other_threshold = 0.03, nday_threshold = 5, ndays = 60)
```
...
plotAllLineagesByLocation(country, other_threshold = 0.03, nday_threshold = 5, ndays = 60)
```
...
plotAllLineagesByLocation(country, other_threshold = 0.05, nday_threshold = 5, ndays = 365, other_exclude = "a.1")
```
...
who_prevalence = getPrevalence(pangolin_lineage = c(alpha_lineages, epsilon_lineages, iota_lineages, delta_lineages), location = country)
...
```{r custom_variants}
delta_y145H = getPrevalence(pangolin_lineage = delta_lineages, mutations="S:Y145H", location = country)
e484k = getPrevalence(mutations="S:E484K", location = country)
e484k_p618h = getPrevalence(mutations=c("S:E484K", "S:P681H"), location = country)
